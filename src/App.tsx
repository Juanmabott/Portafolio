...
function App() {
  ...
  return (
    <>
      ...
      {/* Contenedor centrado: ocupa todo el ancho disponible pero con un max-width centrado */}
      <div className="content-container w-full">
        <div className="main-container flex justify-center">
          <div className="w-full max-w-screen-2xl px-5">

            {/* Layout responsive: en pantallas md+ muestra fila con fuego a la izquierda y contenido a la derecha */}
            <div className="layout flex flex-col md:flex-row items-start gap-6">
              
              {/* Columna izquierda: fuego ASCII (se adapta) */}
              <aside className="fire-aside w-full md:w-1/3 lg:w-1/4 flex-shrink-0">
              ...
              <div className="portfolio-column w-full md:flex-1">
                <div className="portfolio z-10 overflow-hidden w-full">
                  {/* Header ahora ocupa el ancho del contenedor centrado */}
                  <header className="header w-full py-6 flex">
                    <div className="mr-8">
                    ...
                    <div className="header-text">
                      ...
                      <div className="contact-links flex flex-col items-start">
                        <a
                          href="https://www.linkedin.com/in/juan-manuel-bottaro"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="contact-link linkedin flex items-center"
                        >
                          <img
                        ...
                        <a
                          href="https://github.com/Juanmabott"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="contact-link github flex items-center"
                        >
                          <img
            ...
            {isAboutPanelOpen && <AboutPanel closePanel={toggleAboutPanel} />}
